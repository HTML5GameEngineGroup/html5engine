...
function GameObject(renderableObj) {
    ...
    currentScene.mAllObject.addToSet(this);
...
GameObject.prototype.destory = function () {
    var i;
    var index = currentScene.mAllRenderable.indexOf(this.mRenderComponent);
    if (index > -1)
        currentScene.mAllRenderable.splice(index, 1);
    var set=currentScene.mObjectSetTable.getItem(this);
    for (i = 0; i < set.length; i++) {
        set[i].removeFromSet(this);
    }
    currentScene.mObjectSet.removeItem(this);
};