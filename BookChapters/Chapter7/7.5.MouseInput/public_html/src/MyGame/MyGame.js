...
MyGame.prototype.Update = function()
{
    ...
    if (gEngine.Input.IsButtonPressed(gEngine.Input.MouseButton.Left)) {
        msg += "[L Down]";
        if (this._mCamera.IsMouseInViewport()) {
            this._mPortal.GetXform().SetXPos(this._mCamera.MouseWCX());
            this._mPortal.GetXform().SetYPos(this._mCamera.MouseWCY());
        }
    }
    
    if (gEngine.Input.IsButtonPressed(gEngine.Input.MouseButton.Middle)) {
        if (this._mHeroCam.IsMouseInViewport()) {
            this._mHero.GetXform().SetXPos(this._mHeroCam.MouseWCX());
            this._mHero.GetXform().SetYPos(this._mHeroCam.MouseWCY());
        }
    }
    
    if (gEngine.Input.IsButtonClicked(gEngine.Input.MouseButton.Right)) 
        this._mPortal.SetVisibility(false);
        
    if (gEngine.Input.IsButtonClicked(gEngine.Input.MouseButton.Middle))
        this._mPortal.SetVisibility(true);
