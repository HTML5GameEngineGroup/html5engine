...
Hero.prototype.update = function () {
    ...
    if (this.mName == "center")
    {
        // control the selected light
        var msg = "L=" + gCurrentScene.mLgtIndex + " ";
        msg += gCurrentScene._lightControl();
        gCurrentScene.mMsg.setText(msg);

        msg = gCurrentScene._selectCharacter();
        msg += gCurrentScene.materialControl();
        gCurrentScene.mMatMsg.setText(msg);
    }
};