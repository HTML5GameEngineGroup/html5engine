...
function FontRenderable(aString,mAutoDrawFlag) {
    this.mFont = gEngine.DefaultResources.getDefaultFont();
    this.mOneChar = new SpriteRenderable(this.mFont + ".png",true);
    this.mXform = new Transform(); // transform that moves this object around
    this.mText = aString;
    this.mVisible = true;
    if(mAutoDrawFlag)
        this.mAutoDrawEnable=true;
    else this.mAutoDrawEnable=false;
    this.mDrawed = false;
    gCurrentScene.mAllDrawSet.push(this);
}
