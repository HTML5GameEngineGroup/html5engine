 ...
 * Subclass from DiffuseShader (to take advantage of light sources)
 */
...
function IllumShader(vertexShaderPath, fragmentShaderPath)
{
    ...
    DiffuseShader.call(this, vertexShaderPath, fragmentShaderPath);  // call super class constructor
...
gEngine.Core.InheritPrototype(IllumShader, DiffuseShader);
//</editor-fold>
...
IllumShader.prototype.ActivateShader = function(pixelColor, aCamera) {
    ...
    DiffuseShader.prototype.ActivateShader.call(this, pixelColor, aCamera);
    var gl = gEngine.Core.GetGL();
...
IllumShader.prototype.CleanUp = function()
{
    ...
    DiffuseShader.prototype.CleanUp.call(this);
};
//</editor-fold>