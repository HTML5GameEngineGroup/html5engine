...
gEngine.Core = (function () {
    ...
    var _initializeWebGL = function (htmlCanvasID) {
        ...
        mGL = canvas.getContext("webgl", {depth: true, stencil: true}) || canvas.getContext("experimental-webgl", {depth: true, stencil: true});
    ...
    var clearCanvas = function (color) {
        ...
        mGL.clear(mGL.COLOR_BUFFER_BIT | mGL.DEPTH_BUFFER_BIT);      // clear to the color previously set
    };
