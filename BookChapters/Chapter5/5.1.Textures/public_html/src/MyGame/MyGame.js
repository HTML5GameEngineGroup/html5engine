...
MyGame.prototype.Initialize = function() 
{
    ...
    this._mPortal = new TextureRenderable(gEngine.SystemResources.GetTextureShader(), this._kPortal);
    this._mPortal.SetColor([1, 0, 0, 0.2]);  // tints red
    this._mPortal.GetXform().SetPosition(25, 60);
    this._mPortal.GetXform().SetSize(3, 3);
    
    this._mCollector = new TextureRenderable(gEngine.SystemResources.GetTextureShader(), this._kCollector);
