...
ShaderLightAtIndex.prototype._SetShaderReferences = function(aDiffuseShader, index) {
    ...
    this._mSpecIntensityRef = gl.getUniformLocation(aDiffuseShader,  "uLights[" + index + "].SpecIntensity");
    this._mShinningnessRef = gl.getUniformLocation(aDiffuseShader,  "uLights[" + index + "].Shinningness");
